"""General launcher for the ros2neuro BCI pipeline, LSL acquisition backend.

Combines, for now: EEG acquisition (LSL backend, hardcoded), XDF session
recording, and the two-class threshold game controller. More nodes
...
def generate_launch_description() -> LaunchDescription:
    ...
    launch_args = [
        DeclareLaunchArgument(
            ...
            description="Acquisition parameter file (LSL backend's config).",
        ),
        DeclareLaunchArgument(
            "framerate",
