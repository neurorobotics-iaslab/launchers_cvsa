...
Usage:
    ...
    ros2 launch launchers_bci control_lsl.launch.py target:=host th_extreme_right:=0.25
    ros2 launch launchers_bci control_lsl.launch.py controller:=no_dead_zone
"""
...
THRESHOLD_DEFAULTS = {
    ...
    "th_right": "0.40",  # center-right edge
    "th_left": "0.70",  # center-left edge
    "th_extreme_left": "0.8",  # left edge
}
